...
import { type PackageFile, getFile, listFiles } from "./pkg-files.ts";
    ...
    globalThis.fetch = async (input: RequestInfo | URL) => {
      ...
      switch (url.toString()) {
        ...
        case "https://registry.npmjs.org/material/-/material-5.16.7.tgz":
          return fileResponse(packageTarballs.material["5.16.7"]);
        case "https://registry.npmjs.org/moment/-/moment-2.29.0.tgz":
          return fileResponse(packageTarballs.moment["2.29.0"]);
