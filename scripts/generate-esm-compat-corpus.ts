...
const packageSeeds: PackageSeed[] = [
  ...
  { name: "d3", category: "large-graph", scenarios: [] },
  { name: "d3-array", category: "large-graph" },
  { name: "d3-scale", category: "large-graph" },
  { name: "date-fns", category: "browser", scenarios: [] },
  ...
  { name: "lit", category: "framework", scenarios: [] },
  { name: "lodash", category: "cjs" },
  { name: "lodash-es", category: "browser", scenarios: [] },
  ...
  { name: "rxjs", category: "browser", scenarios: [] },
  ...
  { name: "three", category: "large-graph", scenarios: [] },
  { name: "monaco-editor", category: "large-graph", scenarios: [] },
  ...
  { name: "ag-grid-community", category: "large-graph", scenarios: [] },
